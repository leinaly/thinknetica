...
#south obj for checking specification
  ...
  south_train = PassengerTrain.new("12343")
  ...
  north_train = CargoTrain.new("43213")
  ...
  car_wagon.company_name = "My company"
  puts car_wagon.company_name

  puts "Train : #{CargoTrain.instances}"
  puts "Route : #{Route.instances}"
  puts "Station : #{Station.instances}"

  Station.all
  puts Train.find("12343")
  puts Train.find("333")
